const String baseUrl = 'https://ib.jamalmoallart.com/api/v2';
...
final List<Map<String, dynamic>> productData = [
  ...
  },
  {
    ...
    "category": "Wearables",
    "description": "Smartwatch with fitness tracking, GPS, and notifications.",
    "price": 400,
    "discount": 10,
    "image":
...
final List<String> categories =
    productData.map((p) => p['category'] as String).toSet().toList();
